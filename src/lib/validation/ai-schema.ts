...
export const AIResponseSchema = z.object({
  intent: IntentEnum,
  module: z.string().describe("Módulo relacionado: 'finance', 'livestock', 'maintenance', 'inventory', 'hr', 'operations'"),
  ...
  secondary_actions: z.array(SecondaryActionSchema).nullable().optional().describe("Lista de ações secundárias quando uma mensagem gera múltiplos eventos (ex: compra de gado = movimento + despesa)."),
